...
```
.doc-agents/
├── block-list.md              # Glob patterns to exclude from docs
...
Create `.doc-agents/block-list.md` to exclude files from documentation references:
...
Files matching these patterns will be excluded from Code Map, Data Flow, citations, and Related Files Index. `**/CLAUDE.md` is included by default.
